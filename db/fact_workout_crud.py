...
async def create_fact_workout(workout_id: int, user_id: int, created_at: date) -> FactWorkout:
    async with get_session() as session:
        ...
        fact_workout = FactWorkout(user=user, workout=workout, created_at=created_at)
